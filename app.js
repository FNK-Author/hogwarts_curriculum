(function () {
  ...
  function choiceCard(id, bucket, name, note, color, icon, tag, checked, disabled, unavailable) {
    return '<label class="choice-card form-reveal-card ' + (unavailable ? 'is-disabled' : '') + (checked ? ' is-selected' : '') + '" style="--accent:' + color + '"><input type="checkbox" value="' + id + '" data-bucket="' + bucket + '" ' + checked + ' ' + disabled + '><span class="choice-icon">' + icon + '</span><span class="choice-main"><span class="choice-name">' + name + '</span><span class="choice-meta">' + note + '</span></span><span class="choice-tag">' + tag + '</span></label>';
  }
