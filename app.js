(function () {
  ...
  function loadState() {
    var fallback = { name: '', house: 'gryffindor', year: 1, electives: [], clubs: [], trips: [], muted: false, language: 'de', scheduleFilter: 'all', mobileDay: 'monday', disguiseOpen: false, muggleMode: false, aliasMode: false, timeEditorOpen: false, customTimes: {}, customLabels: {}, customModules: [] };
    try {
